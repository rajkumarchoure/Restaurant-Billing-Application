...
if(isset($_POST['submit']))
{
	...
	//check Duplicate
	$check = check_duplicate($tblname,"catname = '$catname' && $tblpkey <> $keyvalue");
			...
			if($keyvalue == 0)
		{
			$form_data = array('catname'=>$catname,'status'=>$enable,'ipaddress'=>$ipaddress,'createdate'=>$createdate);
		...
		{
			//update
			$form_data = array('catname'=>$catname,'status'=>$enable,'ipaddress'=>$ipaddress,'lastupdated'=>$createdate);
                ...
                <div class="widgetcontent  shadowed nopadding">
                    ...
                    <?php echo  $dup;  ?>
                       <div class="lg-12 md-12 sm-12">
                                ...
                                <span class="field"><input type="text" name="catname" id="catname" class="input-xxlarge" value="<?php echo $catname;?>" 
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="18%" class="head0">Menu Heading Name</th>

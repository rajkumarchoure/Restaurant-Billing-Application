...
if(isset($_POST['submit']))
{
	...
	//check Duplicate
	$check = check_duplicate($tblname,"unit_name = '$unit_name' && $tblpkey <> $keyvalue");
		   ...
		   {
			//insert
			$form_data = array('unit_name'=>$unit_name,'enable'=>$enable,'ipaddress'=>$ipaddress,'createdate'=>$createdate);
		...
		{
			//update
			$form_data = array('unit_name'=>$unit_name,'enable'=>$enable,'ipaddress'=>$ipaddress,'lastupdated'=>$createdate);
              ...
              <?php include("../include/alerts.php"); ?>
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                               ...
                               <?php
									$slno=1;
									$sql_get = mysql_query("select * from m_unit where 1=1 order by unitid desc");

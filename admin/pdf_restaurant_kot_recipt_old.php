...
if(isset($_GET['kotid']))
{	
	$kotid  = addslashes($_GET['kotid']);
	$table_id= $cmn->getvalfield("kot_entry","table_id","kotid='$kotid'");
	$kotdate = $cmn->dateformatindia($cmn->getvalfield("kot_entry","kotdate","kotid='$kotid'"));
	$kottime = $cmn->getvalfield("kot_entry","kottime","kotid='$kotid'");
	$billid = $cmn->getvalfield("kot_entry","billid","kotid='$kotid'");
	
	$height = $cmn->getvalfield("bill_details","count(*)","kotid='$kotid'");
...
$slno=1;
	...
	$sql_get = mysql_query("select * from bill_details where kotid='$kotid'");

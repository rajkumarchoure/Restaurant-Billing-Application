...
{	
	...
	$height = $cmn->getvalfield("bill_details","count(*)","billid='$billid' and table_id='$table_id'");
	$pageheight = 10 * 120;
}
...
//echo "select * from bill_details where table_id=$table_id"; die;
	$sql_get = mysql_query("select * from bill_details where table_id='$table_id' and billid='$billid' and kotid='$lastkotid'");

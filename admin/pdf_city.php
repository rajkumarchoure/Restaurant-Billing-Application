...
$title1 = $cmn->getvalfield("m_branch","branch_name ","branchid = '$loginid' ");
$pdf->SetTitle($title1);
$title2 = "City Details";
$pdf->SetTitle($title2);
...
$pdf->Cell(70,6,'City Name',1,0,'L',0);
$pdf->Cell(55,6,'Pin-Code',1,0,'L',0);
$pdf->Cell(60,6,'State',1,1,'L',0);


$pdf->SetX(5);
$pdf->SetWidths(array(10,70,55,60));
$pdf->SetFont('Arial','',6);
...
$sql_get = mysql_query("select * from master_city where 1=1 order by city_id desc");
	...
	$pdf->Row(array($slno++,$row_get['city_name'],$row_get['pin_code'],$state_name." ( ".$count_name." ) "));

...
if(isset($_POST['submit']))
{
	...
	//{
		...
		//{
			...
			$old_file1 = $cmn->getvalfield("m_branch","imgname","branchid = '$branchid'");
				...
				{				
					...
					//$cmn->convert_image($file_name,"uploaded/","150","150");
					 ...
					 //echo "Update m_users set imgname = '$file_name' where userid = '$userid'  ";die;
					  mysql_query("Update m_branch set imgname = '$file_name' where branchid = '$branchid'");
				}
			$action=2;
			$process = "updated";
		
		 $cmn->InsertLog($pagename, $module, $submodule, $tblname, $tblpkey, $userid, $process);

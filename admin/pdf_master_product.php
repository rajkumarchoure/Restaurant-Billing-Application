...
$pdf->Cell(40,6,'Product Name',1,0,'L',0);
$pdf->Cell(25,6,'Categary Name',1,0,'L',0);
$pdf->Cell(40,6,'Unit Name',1,0,'L',0);
$pdf->Cell(40,6,'Rate',1,0,'L',0);
$pdf->Cell(40,6,'Discount',1,1,'L',0);



$pdf->SetX(5);
$pdf->SetWidths(array(10,40,25,40,40,40));
$pdf->SetFont('Arial','',6);
...
$sql_get = mysql_query("select * from m_product where 1=1 order by productid desc");
	...
	$pdf->Row(array($slno++,$prodname,$catname,$unit_name,$rate,$disc));
